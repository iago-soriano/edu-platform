...
import { IBaseCollection, IPaginatedParams, TokenDTO, UserDTO } from '@interfaces';
...
export class NeDBDatabase {
    ...
    constructor() {       
        this.Users = new NeDBCollection<UserDTO>(Datastore.create({ filename: `db/Users.db`, autoload: true }));
        this.Tokens = new NeDBCollection<TokenDTO>(Datastore.create({ filename: `db/Tokens.db`, autoload: true }));
    }
}
