...
const inputStyles = tv({
  base: [
    ...
    [
      ...
      "file:border-solid file:border-gray-300 file:bg-gray-50 file:text-gray-500 file:hover:bg-gray-100 file:dark:border-gray-800 file:dark:bg-gray-900 file:hover:dark:bg-gray-900/20 file:disabled:dark:border-gray-700",
        ...
        {submitForm && (
          ...
          >
            <button
              ...
              className={cx(
                // base
                "h-fit w-fit outline-none transition-all bg-gray-100 dark:bg-gray-900 p-1 rounded-full",
                // text
