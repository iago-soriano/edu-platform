...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col">
      <section className="grid lg:grid-cols-2 grid-cols-1 items-center w-full bg-surface2 h-[80vh]">
      ...
      <section>
        ...
        <div className="lg:w-[70%] w-[90%] mx-auto flex md:flex-row flex-col justify-around items-center md:[&>:nth-child(even)>img]:order-none [&>:nth-child(even)>img]:order-first">
          <Step
            title={1}
            description={"Passo 1"}
      ...
      <FeatureSection>
        <FeatureTextContainer>
          <h3 className="my-5">Feature 1</h3>
          <ul>
      ...
      <FeatureSection>
        <FeatureImage src={""} />
        <FeatureTextContainer>
          <h3 className="my-5">Feature 2</h3>
          <ul>
            <li className="">Primeiro item</li>
            <li className="">Primeiro item</li>
            <li className="">Primeiro item</li>
